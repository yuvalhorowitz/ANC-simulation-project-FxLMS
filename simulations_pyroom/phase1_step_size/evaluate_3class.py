"""
Phase 1: Evaluate 3-Class Step Size Selector

Compares 3-class adaptive step size selection (Low/Medium/High μ) against fixed baseline.

Input: output/models/phase1/step_selector_3class.pt
Output: output/plots/phase1/comparison_3class_*.png
"""
...
from src.ml.phase1_step_size.adaptive_fxlms_3class import ThreeClassAdaptiveFxNLMS
...
def run_adaptive_simulation(noise_signal, paths, model_path):
    ...
    adaptive_fxnlms = ThreeClassAdaptiveFxNLMS(
        filter_length=FILTER_LENGTH,
        secondary_path_estimate=s_hat,
    ...
    # (matches training data collection after fix)
...
def main():
    ...
    results_path = data_dir / 'evaluation_results_3class.json'
