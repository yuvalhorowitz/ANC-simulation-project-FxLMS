"""
Phase 1: Evaluate Binary Step Size Selector

Compares binary adaptive step size selection (Low μ vs High μ) against fixed baseline.

Input: output/models/phase1/step_selector_binary.pt
Output: output/plots/phase1/comparison_binary_*.png
"""
...
from src.ml.phase1_step_size.adaptive_fxlms_binary import BinaryAdaptiveFxNLMS
...
def run_adaptive_simulation(noise_signal, paths, model_path):
    ...
    adaptive_fxnlms = BinaryAdaptiveFxNLMS(
        filter_length=FILTER_LENGTH,
        secondary_path_estimate=s_hat,
...
def main():
    ...
    results_path = data_dir / 'evaluation_results_binary.json'
